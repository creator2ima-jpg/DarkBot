...
client.on('qr', qr => {
    ...
    console.log('🔗 امسك الهاتف وامسح الـ QR (هذه آخر مرة بإذن الله)');
});
...
// =========================================
// 📩 7. نظام استقبال الرسائل والأوامر (مع الرادار)
// =========================================
client.on('message_create', async msg => {
    try {
        ...
        // 🟢 رادار التتبع (يظهر في السجلات)
        console.log(`[رادار] رسالة: "${text}" | الرقم: ${senderNumber} | المالك؟ ${isBotOwner} | الجروب؟ ${chat.isGroup}`);
